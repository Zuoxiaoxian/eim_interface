...
let map_trace = {
    // 初始化map地图 map_trace
    initmap(map_trace_1, initpoint) {
        console.log("初始化map！", initpoint);
        map = new BMap.Map(map_trace_1); //创建地图实例
    ...
    trace() {
        ...
        TraceControl.prototype.initialize = function(map_data) {
                // 创建一个DOM元素
                ...
                map_data.getContainer().appendChild(card);
                // 将DOM元素返回
                return card;
            }
            // 创建控件
