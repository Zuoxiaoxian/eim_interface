...
layui.define("jquery", function(e) {
    ...
    D.prototype.config = {
        ...
        i(c)[0] && i(c).data("index") == e.index ? e.removePicker(D.thisElemInd) : (e.removePicker(D.thisElemInd), i(o.aline ? o.aline : "body").append(t)), D.thisElemInd = e.index, D.thisColor = r.style.background, e.position(), e.pickerEvents()
        ...
        var e = this,
            ...
            Y = function(e) {
                i("#LAY-colorpicker-moving")[0] || i(o.aline ? o.aline : "body").append(M), M.on("mousemove", e), M.on("mouseup", function() {
                    M.remove()
